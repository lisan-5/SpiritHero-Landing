...
export const metadata: Metadata = {
  title: "Log In | Spirit Hero",
  description: "Sign in to your Spirit Hero account to manage your custom merch stores, track orders, and view your dashboard.",
};
      ...
      <div className="auth-container">
        ...
        <div className="auth-card">
          <div className="auth-card-header">
            <h1>Welcome back</h1>
            <p>Sign in to manage your merch stores and track orders.</p>
          </div>
